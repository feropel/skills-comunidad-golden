...
## 🔴 ADVERTENCIA DURA — 3 límites no documentados de Horizon/Pitch (G4.2, chat un producto de cliente 2026-08-07)
...
## 🟠 RECETA PROBADA Horizon/Pitch (G4.2 — funcionó en tienda real, chat un producto de cliente)
